...
BASE_DIR = os.path.dirname(EXPERIMENTAL_DIR)  # Project root
FIGURES_DIR = os.path.join(EXPERIMENTAL_DIR, 'figures')
DATA_FILE = os.path.join(EXPERIMENTAL_DIR, 'data', '80P.txt')
